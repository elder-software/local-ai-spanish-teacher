...
object ConversationTopics {
    private val madridFood = ConversationTopic(
        id = "madrid_food",
    ...
    private val jobInterview = ConversationTopic(
        id = "job_interview",
    ...
    private val directions = ConversationTopic(
        id = "directions",
    ...
    private val hotelCheckin = ConversationTopic(
        id = "hotel_checkin",
    ...
    private val apartmentViewing = ConversationTopic(
    ...
    private val clothingStore = ConversationTopic(
        id = "clothing_store",
    ...
    private val trainStation = ConversationTopic(
        id = "train_station",
        title = "Train Station",
    ...
    private val bankAccount = ConversationTopic(
        id = "bank_account",
    ...
    private val weekendSmallTalk = ConversationTopic(
    ...
    private val childhoodMemories = ConversationTopic(
    ...
    private val personalGoal = ConversationTopic(
        id = "personal_goal",
        title = "Personal Goal",
    ...
    private val family = ConversationTopic(
        id = "family",
        title = "Family",
    ...
    private val hobby = ConversationTopic(
        id = "hobby",
    ...
    private val yourDay = ConversationTopic(
        id = "your_day",
    ...
    val categories: List<TopicCategory> = listOf(
        TopicCategory(
            id = "free",
            title = "Free",
            description = "Start here. These two scenes are open to everyone.",
            isFree = true,
            topics = listOf(madridFood, yourDay),
        ),
        TopicCategory(
            id = "travel",
            title = "Travel",
            description = "Find your way and feel at home on the move.",
            topics = listOf(directions, hotelCheckin, trainStation, madridFood),
        ),
        TopicCategory(
            id = "everyday",
            title = "Everyday Errands",
            description = "Handle the small, real-life moments with confidence.",
            topics = listOf(clothingStore, bankAccount, apartmentViewing),
        ),
        TopicCategory(
            id = "work",
            title = "Work & Goals",
            description = "Talk about ambitions, work, and what drives you.",
            topics = listOf(jobInterview, personalGoal),
        ),
        TopicCategory(
            id = "social",
            title = "Social & Connection",
            description = "Relaxed conversations about life, people, and stories.",
            topics = listOf(weekendSmallTalk, family, hobby, childhoodMemories, yourDay),
        ),
    )

    val all: List<ConversationTopic> = categories.flatMap { it.topics }.distinctBy { it.id }
