...
object Pcm16AudioTrimmer {
    ...
    private const val MAX_BYTES = SAMPLE_RATE * BYTES_PER_SAMPLE * MAX_DURATION_MS / 1_000
    ...
    fun trim(pcmData: ByteArray): ByteArray {
        ...
        val end = minOf(usableSize, start + MAX_BYTES, speechEnd)
